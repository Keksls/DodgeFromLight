...
namespace Slyvek_Launcher
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Core.Initialize();
            tbTitle.Text = "Slyvek Launcher - v" + Core.CurrentVersion.ToString();
            if (Core.CheckUpdate())
            {
                ...
                rtbLocal.Visibility = Visibility.Hidden;
                rtbOff.Visibility = Visibility.Hidden;
            }
            else
            {
                ...
                rtbOff.Visibility = Visibility.Visible;
                rtbLocal.Visibility = Visibility.Visible;
            }
        }
        ...
        private void PlayButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Core.StartSlyvek(rtbOff.IsChecked.Value ? Core.OfficielIP : Core.LocalIP);
            }
            catch (Exception ex)
            {
        ...
        private void MenuItem_StartServer_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Core.StartServer();
